<template id="template-table">
    <div class="row">
        <div class="col-sm-12 col-md-4 col-md-offset-8 input-field input-search-table" v-show="filters.length > 0">
        ...
        <table class="table table-sm table-bordered">
         ...
         <!-- Paginador -->
        <div class="col-sm-12 center-align" v-show="pages.length > 1">
            <ul class="pagination">
